...
from Login.loginBackend import validate_account, goto_signup
...
def create_loginUI (parentwindow): 
    ...
    btn_signup = customtkinter.CTkButton(loginframe, text = "Sign Up", command = lambda: goto_signup(parentwindow, loginframe))
